...
import com.kkuil.blackchat.web.chat.domain.vo.request.message.body.TextMessageReqBody;
import com.kkuil.blackchat.web.chat.domain.vo.response.message.body.TextMessageRespBody;
...
public class TextMessageHandler extends AbstractMessageHandler<TextMessageRespBody> {
    ...
    public TextMessageRespBody buildResponseBody(Message message) {
        ...
        return builder
                .atUidList(extra.getAtUidList())
                .urlContentMap(extra.getUrlContentMap())
                .build();
    }
